...
const AddReview = () => {
    ...
    const handleAddReview = e => {
        ...
        fetch('https://frozen-hollows-26442.herokuapp.com/addReviews', {
            method: 'POST',
            headers: {
    ...
    return (
        <Container className="d-flex flex-column align-items-center my-5 my-md-0">
            ...
            <Form onSubmit={handleAddReview} className="d-flex flex-column justify-content-center col-md-6 col-12">
                ...
                <Form.Control className="mb-2" type="number" ref={ratingRef} placeholder="Rating(0 to 5)" min="0" max="5" />
                <Button type="submit" variant="warning">Add Review</Button>
            </Form>
        </Container>
    );
};
